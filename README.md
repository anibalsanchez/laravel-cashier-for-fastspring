...
Add `photalika/laravel-cashier-fastspring` package to your dependencies.

```bash
composer require "photalika/laravel-cashier-fastspring"
```
...
> case, use the original `photalika` username, but replace `BRANCHNAME` with the
> fork's branch name):
>
> ```json
> "require": {
>     "photalika/laravel-cashier-fastspring": "dev-BRANCHNAME"
> }
> ```
...
Thank you for considering contributing to the Cashier For Fastspring. You can read the contribution guide lines [here](contributing.md). You can also check [issues](https://anibalsanchez/laravel-cashier-fastspring-v12/issues) to improve this package.
